...
import com.octalsoftware.drewel.activity.CompletedOrderDetailActivity;
...
public class CompletedOrderFragmentAdapter extends RecyclerView.Adapter<CompletedOrderFragmentAdapter.ViewHolder> {
...
//        public TextView btn_accept_order;
    ...
    public CompletedOrderFragmentAdapter(Context context, List<OrderModel> order, OnClickItemListener OnClickItemListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.child_completed_order, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.btn_order_details.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                context.startActivity(new Intent(context, CompletedOrderDetailActivity.class).putExtra(Tags.DATA, orderModel));
            }
        });
    }
